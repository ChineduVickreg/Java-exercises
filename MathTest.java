...
// A program to test the Math class methods.
...
public class MathTest {
    public static void main(String[]args){
        ...
        System.out.printf("Math.log(Math.E * Math.E) = %f%n", Math.log(Math.E));
        System.out.printf("Math.ceil(Math.E*Math.E) = %f%n", Math.log(Math.E*Math.E));
